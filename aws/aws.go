...
func SendFileToInstance(key string, url string){
...
func createUsers(url string, usuarios []string) {
    key := "/home/daniel/Downloads/slackaws.pem";
    SendFileToInstance(key, url);
